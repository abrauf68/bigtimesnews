                ...
                <form method="POST" action="{{ route('dashboard.authors.update', $author->id) }}" enctype="multipart/form-data">
                    ...
                    <div class="row p-5">
                        ...
                        <div class="mb-4 col-md-12">
                            ...
                            @enderror
                            @if($author->image)
                                <img src="{{ asset($author->image) }}" alt="main image" class="mt-2" width="120">
                            @endif
                        </div>
                        <div class="mb-4 col-md-12">
                        ...
                        <div class="mb-4 col-md-6">
                            ...
                            <input class="form-control @error('threads') is-invalid @enderror" type="text" id="threads"
                                ...
                                value="{{ old('threads', $author->threads) }}" />
                            @error('threads')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="mt-2">
                        <button type="submit" class="btn btn-primary me-3">{{ __('Edit Author') }}</button>
                    </div>
                </form>
            </div>
            <!-- /Account -->
